...
int main(){
...

	{
		// Milestone 2
		// cout << "|--------------------------- |" << endl;
		// cout << "|Beginning milestone 2 check-|" <<endl;
		// cout << "|----------------------------|"<<endl;
		...
		// // cout << "begin tmp2 display" << endl;
		// tmp2.display(cout);
		// // cout << endl;

		// //Calls the segmentation error
...
template<typename T>
//loads the lines from the file into theCollection, which is a vector of type T
